...
...                     ${lbl_home_anime}            ${lbl_home_live_programs}     ${lbl_home_popular_tv}     ${lbl_home_premium_tv}      ${lbl_home_premium}
...                     ${lbl_home_premium_rerun}    ${lbl_home_playnews}          ${lbl_home_thai_series}    ${lbl_home_you_may_like}    ${lbl_home_thai_movies}
...                     ${lbl_home_action}           ${lbl_home_chinese}           ${lbl_home_idol}           ${lbl_home_animation}       ${lbl_home_cartoons}
...                     ${lbl_home_comedy}           ${lbl_home_drama}             ${lbl_home_romance}        ${lbl_home_horror}          ${lbl_home_concerts}
...                     ${lbl_home_sports}
...
@{list_favorites}       ${lbl_favorites_live}    ${lbl_favorites_movies}    ${lbl_favorites_serie}        
